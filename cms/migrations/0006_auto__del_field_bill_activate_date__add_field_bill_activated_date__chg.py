...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bill.activate_date'
        db.delete_column('cms_bill', 'activate_date')

        # Adding field 'Bill.activated_date'
        db.add_column('cms_bill', 'activated_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'Bill.expired_date'
        db.alter_column('cms_bill', 'expired_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'MyBill.activate_date'
        db.delete_column('cms_mybill', 'activate_date')

        # Adding field 'MyBill.activated_date'
        db.add_column('cms_mybill', 'activated_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'MyBill.expired_date'
        db.alter_column('cms_mybill', 'expired_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Adding field 'Bill.activate_date'
        db.add_column('cms_bill', 'activate_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Deleting field 'Bill.activated_date'
        db.delete_column('cms_bill', 'activated_date')


        # Changing field 'Bill.expired_date'
        db.alter_column('cms_bill', 'expired_date', self.gf('django.db.models.fields.DateTimeField')(default=None))
        # Adding field 'MyBill.activate_date'
        db.add_column('cms_mybill', 'activate_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=False),
                      keep_default=False)

        # Deleting field 'MyBill.activated_date'
        db.delete_column('cms_mybill', 'activated_date')


        # Changing field 'MyBill.expired_date'
        db.alter_column('cms_mybill', 'expired_date', self.gf('django.db.models.fields.DateTimeField')(default=False))
