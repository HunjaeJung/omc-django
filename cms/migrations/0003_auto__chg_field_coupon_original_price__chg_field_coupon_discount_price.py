...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coupon.original_price'
        db.alter_column('cms_coupon', 'original_price', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Coupon.discount_price'
        db.alter_column('cms_coupon', 'discount_price', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Coupon.original_price'
        db.alter_column('cms_coupon', 'original_price', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Coupon.discount_price'
        db.alter_column('cms_coupon', 'discount_price', self.gf('django.db.models.fields.FloatField')())
