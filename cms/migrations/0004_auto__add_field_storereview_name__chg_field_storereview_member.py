...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreReview.name'
        db.add_column('cms_storereview', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


        # Changing field 'StoreReview.member'
        db.alter_column('cms_storereview', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Member'], null=True))

    def backwards(self, orm):
        # Deleting field 'StoreReview.name'
        db.delete_column('cms_storereview', 'name')


        # Changing field 'StoreReview.member'
        db.alter_column('cms_storereview', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cms.Member']))
