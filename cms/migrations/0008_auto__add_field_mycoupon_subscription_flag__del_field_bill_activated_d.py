...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyCoupon.subscription_flag'
        db.add_column('cms_mycoupon', 'subscription_flag',
        ...
        # Deleting field 'Bill.expired_date'
        db.delete_column('cms_bill', 'expired_date')

        # Deleting field 'MyBill.activated_date'
        db.delete_column('cms_mybill', 'activated_date')

        # Deleting field 'MyBill.bill_type'
        db.delete_column('cms_mybill', 'bill_type')


    def backwards(self, orm):
        # Deleting field 'MyCoupon.subscription_flag'
        db.delete_column('cms_mycoupon', 'subscription_flag')
        ...
        # Adding field 'Bill.expired_date'
        db.add_column('cms_bill', 'expired_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
        ...
        # Adding field 'MyBill.bill_type'
        db.add_column('cms_mybill', 'bill_type',
