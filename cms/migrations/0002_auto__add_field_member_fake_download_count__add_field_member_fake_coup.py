...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.fake_download_count'
        db.add_column('cms_member', 'fake_download_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Member.fake_coupon_used_count'
        db.add_column('cms_member', 'fake_coupon_used_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Member.is_fake_id'
        db.add_column('cms_member', 'is_fake_id',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.fake_download_count'
        db.delete_column('cms_member', 'fake_download_count')

        # Deleting field 'Member.fake_coupon_used_count'
        db.delete_column('cms_member', 'fake_coupon_used_count')

        # Deleting field 'Member.is_fake_id'
        db.delete_column('cms_member', 'is_fake_id')
