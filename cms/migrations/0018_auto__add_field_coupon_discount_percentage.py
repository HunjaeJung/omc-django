...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.discount_percentage'
        db.add_column('cms_coupon', 'discount_percentage',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.discount_percentage'
        db.delete_column('cms_coupon', 'discount_percentage')
