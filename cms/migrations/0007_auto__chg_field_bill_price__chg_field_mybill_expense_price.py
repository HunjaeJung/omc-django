...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bill.price'
        db.alter_column('cms_bill', 'price', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'MyBill.expense_price'
        db.alter_column('cms_mybill', 'expense_price', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Bill.price'
        db.alter_column('cms_bill', 'price', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'MyBill.expense_price'
        db.alter_column('cms_mybill', 'expense_price', self.gf('django.db.models.fields.FloatField')())
