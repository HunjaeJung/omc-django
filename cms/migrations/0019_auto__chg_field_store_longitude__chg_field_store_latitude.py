...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.longitude'
        db.alter_column('cms_store', 'longitude', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Store.latitude'
        db.alter_column('cms_store', 'latitude', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Store.longitude'
        db.alter_column('cms_store', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=7))

        # Changing field 'Store.latitude'
        db.alter_column('cms_store', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=7))
