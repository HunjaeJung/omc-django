...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.search'
        db.add_column('cms_coupon', 'search',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'MyBill.tid'
        db.add_column('cms_mybill', 'tid',
        ...
        # Adding field 'Store.search'
        db.add_column('cms_store', 'search',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=70),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.search'
        db.delete_column('cms_coupon', 'search')

        # Deleting field 'MyBill.tid'
        db.delete_column('cms_mybill', 'tid')

        # Deleting field 'MyBill.useable'
        db.delete_column('cms_mybill', 'useable')

        # Deleting field 'Store.search'
        db.delete_column('cms_store', 'search')
