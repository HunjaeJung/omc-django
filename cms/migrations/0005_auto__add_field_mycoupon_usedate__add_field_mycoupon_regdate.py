...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyCoupon.usedate'
        db.add_column('cms_mycoupon', 'usedate',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MyCoupon.regdate'
        db.add_column('cms_mycoupon', 'regdate',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyCoupon.usedate'
        db.delete_column('cms_mycoupon', 'usedate')

        # Deleting field 'MyCoupon.regdate'
        db.delete_column('cms_mycoupon', 'regdate')
