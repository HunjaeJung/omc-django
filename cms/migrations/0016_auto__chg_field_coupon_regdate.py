...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coupon.regdate'
        db.alter_column('cms_coupon', 'regdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Coupon.regdate'
        db.alter_column('cms_coupon', 'regdate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
