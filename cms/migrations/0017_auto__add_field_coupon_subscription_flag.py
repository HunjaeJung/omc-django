...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.subscription_flag'
        db.add_column('cms_coupon', 'subscription_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.subscription_flag'
        db.delete_column('cms_coupon', 'subscription_flag')
